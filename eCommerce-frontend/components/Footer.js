...
function Footer(props) {
    return (
        <>
            <footer className="w-full bg-grn bottom-0 mt-auto py-8">
                    ...
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                            <div className="mb-10 w-full">
                                ...
                                <p className="flex items-center text-sm font-medium text-ble">
                                    <span className="mr-3 text-ble">
                                      <svg
                                          width="19"
                                          height="21"
                                          viewBox="0 0 19 21"
                                    ...
                                    <span>+212 6 52 43 92 68</span>
                                </p>
                            </div>
                        </div>
                        <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
                            <div className="mb-10 w-full">
                                <h4 className="mb-9 text-lg font-semibold text-ble">Resources</h4>
                                <ul>
                                    <li>
                                        <a
                                            href="#"
                                            className="mb-2 inline-block text-base leading-loose text-body-color hover:text-ble"
                                        >
                                            SaaS Development
                                        </a>
                                    </li>
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
                            <div className="mb-10 w-full">
                                <h4 className="mb-9 text-lg font-semibold text-ble">Company</h4>
                                <ul>
                                    <li>
                                        <a
                                            href="#"
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
                            <div className="mb-10 w-full">
                                <h4 className="mb-9 text-lg font-semibold text-ble">Quick Links</h4>
                                <ul>
                                    <li>
                                        <a
                                            href="#"
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                            <div className="mb-10 w-full">
                                <h4 className="mb-9 text-lg font-semibold text-ble">Follow Us On</h4>
                                <div className="mb-6 flex items-center">
                                    <a
                                        href="#"
                                        className="mr-3 flex h-9 w-9 hover:bg-white hover:border-none items-center justify-center rounded-full border-2 border-dark text-ble hover:border-ble hover:bg-ble hover:text-gan sm:mr-4 lg:mr-3 xl:mr-4"
                                    >
                                        <svg
                                            width="8"
                                            height="16"
                                ...
                                <p className="text-base text-body-color">&copy; {new Date().getFullYear()} HerboLAB</p>
                                <p className="hidden">Made with 🌀 By Zakariae Bouklah : https://zakariaebouklah.github.io/portfolio/</p>
                            </div>
                        </div>
                    </div>
                </div>
